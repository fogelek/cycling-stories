...
{% image "Great start to the day", "IMG_2249", "destination-tauern-part-2" %}
...
{% images 3 %}
{% image "Over the valley", "IMG_2250", "destination-tauern-part-2" %}
{% image "Road to Innerkrems", "IMG_2252", "destination-tauern-part-2" %}
{% image "Road to Innerkrems", "IMG_2257", "destination-tauern-part-2" %}
{% images-end %}

{% images 2 %}
{% image "Firefighters' tests", "IMG_2255", "destination-tauern-part-2" %}
{% image "Almost at the pass", "IMG_2261", "destination-tauern-part-2" %}
{% images-end %}
...
{% images 3 %}
{% image "Schloss Moosham", "IMG_2269", "destination-tauern-part-2" %}
{% image "Water fountain in Mautendorf", "IMG_2287", "destination-tauern-part-2" %}
{% image "Climbing Tauernpass", "IMG_2292", "destination-tauern-part-2" %}
{% images-end %}

{% images 3 %}
{% image "Climbing Tauernpass", "IMG_2293", "destination-tauern-part-2" %}
{% image "Climbing Tauernpass", "IMG_2295", "destination-tauern-part-2" %}
{% image "Tauernpass", "IMG_2296", "destination-tauern-part-2" %}
{% images-end %}
...
{% image "Radstadt", "IMG_2305", "destination-tauern-part-2" %}
{% image "Smooth gravel roads", "IMG_2308", "destination-tauern-part-2" %}
...
{% images 3 %}
{% image "Fixing a flat", "IMG_2310", "destination-tauern-part-2" %}
{% image "Mountains towering over Enns valley", "IMG_2311", "destination-tauern-part-2" %}
{% image "Schladming", "IMG_2315", "destination-tauern-part-2" %}
{% images-end %}

{% images 3 %}
{% image "River Enns", "IMG_2316", "destination-tauern-part-2" %}
{% image "Storm is coming", "IMG_2319", "destination-tauern-part-2" %}
{% image "Railway", "IMG_2324", "destination-tauern-part-2" %}
{% images-end %}
...
{% images 2 %}
{% image "Enns valley", "IMG_2360", "destination-tauern-part-2" %}
{% image "Almost in Oppenberg", "IMG_2371", "destination-tauern-part-2" %}
{% images-end %}

{% images 2 %}
{% image "Quiet road", "IMG_2363", "destination-tauern-part-2" %}
{% image "Kaiserau pass", "IMG_2377", "destination-tauern-part-2" %}
{% images-end %}

{% image "Kaiserau pass", "IMG_2380", "destination-tauern-part-2" %}
...
{% images 2 %}
{% image "Descending into Admont", "IMG_2385", "destination-tauern-part-2" %}
{% image "Gesäuse gate", "IMG_2393", "destination-tauern-part-2" %}
{% images-end %}

{% images 2 %}
{% image "Gesäuse", "IMG_2394", "destination-tauern-part-2" %}
{% image "Gesäuse", "IMG_2396", "destination-tauern-part-2" %}
{% images-end %}

{% images 2 %}
{% image "Gesäuse", "IMG_2401", "destination-tauern-part-2" %}
{% image "Gesäuse", "IMG_2405", "destination-tauern-part-2" %}
{% images-end %}
...
{% image "Leopoldsteiner See,", "IMG_2411", "destination-tauern-part-2" %}

{% images 2 %}
{% image "Leaving Gesäuse", "IMG_2409", "destination-tauern-part-2" %}
{% image "Brigde to Erzberg", "IMG_2419", "destination-tauern-part-2" %}
{% images-end %}

{% images 2 %}
{% image "Mountains over Eisenerz", "IMG_2428", "destination-tauern-part-2" %}
{% image "Top parts of the quarry", "IMG_2431", "destination-tauern-part-2" %}
{% images-end %}
...
{% image "Canal in Mur valley,", "IMG_2443", "destination-tauern-part-2" %}

{% images 2 %}
{% image "Small roads in the Mur valley", "IMG_2439", "destination-tauern-part-2" %}
{% image "Waiting for a train", "IMG_2447", "destination-tauern-part-2" %}
{% images-end %}
...
[Strava - Day 3 - Innerkrems Pass, Tauernpass](https://www.strava.com/activities/14808668036)
[Strava - Rest day](https://www.strava.com/activities/14814547145)
[Strava - Day 4 - Admont, Gesäuse, Präbichl](https://www.strava.com/activities/14827687164)

{% komoot-collection 3497445 %}