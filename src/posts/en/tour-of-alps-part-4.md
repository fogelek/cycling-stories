...
tags:
  - post
  - bikepacking
title: Tour of Alps - Part 4
lang: en
media: tour-of-alps-part-4
switch: /pl/tour-of-alps-czesc-4
thumb: France-392
caption: View from Col de la Lombarde
date: 2025-01-21
---
...
{% image "Hazed views towards Jausiers", "France-373", "tour-of-alps-part-4" %}
...
{% image "Rainy road just above Halte 2000", "France-374", "tour-of-alps-part-4" %}
...
{% image "Bye, Turin", "France-446", "tour-of-alps-part-4" %}

The end.

[Strava - Stage 11 -  Cime de la Bonette, Col de la Lombarde](https://www.strava.com/activities/12155307079)
[Strava - Stage 12 - Cuneo - Torino](https://www.strava.com/activities/12161208480/)

## Interactive map

<iframe class="interactive-map" src="https://ridewithgps.com/embeds?type=event&eventId=343468&metricUnits=true&sampleGraph=true&hideSurface=true&defaultShowAll=true" style="width: 1px; min-width: 100%; height: 700px; border: none; margin-left: 0" scrolling="no"></iframe>

## Climb profiles

<ul class="profiles">
    {% profile "Colle della Maddalena", "38245106" %}
    {% profile "Val Salice", "23826863" %}
    {% profile "Colle delle Finestre" %}
    {% profile "Monceniso" %}
    {% profile "Col du Mont-Cenis" %}
    {% profile "Col de l'Iseran" %}
    {% profile "Col du Petit-Saint-Bernard" %}
    {% profile "Courmayeur / Val Ferret" %}
    {% profile "Du Fayet" %}
    {% profile "Hery-sur-Ugine" %}
    {% profile "Col de la Madeleine" %}
    {% profile "Lacets du Montvernier / Col du Chaussy" %}
    {% profile "Col du Glandon / Col de la Croix de Fer" %}
    {% profile "Col du Mollard" %}
    {% profile "Col du Telegraphe / Col du Galibier" %}
    {% profile "Les Fonts de Cervieres" %}
    {% profile "Col d'Isoard" %}
    {% profile "Col de Vars" %}
    {% profile "Col d'Allos" %}
    {% profile "Col de la Cayolle" %}
    {% profile "Cime de la Bonette" %}
    {% profile "Col de la Lombarde" %}
</ul>

<div class="profile-image" title="Colle della Maddalena" data-url="tour-of-alps-profiles">
    <img src="" alt="Colle della Maddalena"/>
</div>